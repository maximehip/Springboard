...
- (id)_sectionIdentifierAtIndex:(unsigned int)arg1;
- (unsigned int)_numberOfVisibleSections;
- (unsigned int)_indexOfBulletin:(id)arg1 inSection:(id)arg2;
- (id)_bulletinWithIdentifier:(id)arg1 inSection:(id)arg2;
- (id)_bulletinAtIndex:(unsigned int)arg1 inSection:(id)arg2;
...
- (void)_addBulletin:(id)arg1 toSection:(id)arg2 forFeed:(unsigned int)arg3;
...
- (void)_associateBulletin:(id)arg1 withSection:(id)arg2 forFeed:(unsigned int)arg3;
- (void)didAssociateBulletin:(id)arg1 withSection:(id)arg2 forFeed:(unsigned int)arg3;
- (void)willAssociateBulletin:(id)arg1 withSection:(id)arg2 forFeed:(unsigned int)arg3;
- (unsigned int)_feedsForBulletinID:(id)arg1;
- (void)_removeBulletinIDFromAllFeeds:(id)arg1;
- (void)_addBulletinID:(id)arg1 toSetForFeeds:(unsigned int)arg2;
- (void)_addBulletinID:(id)arg1 toSetForFeed:(unsigned int)arg2;
...
- (void)pushUpdatesAgainForFeeds:(unsigned int)arg1;
- (void)pushUpdatesAgainForSectionWithIdentifier:(id)arg1 feeds:(unsigned int)arg2;
