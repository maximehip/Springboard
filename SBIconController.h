...
- (BOOL)appIconForceTouchController:(id)arg1 shouldShowShareApplicationShortcutItemForGestureRecognizer:(id)arg2;
...
- (void)_dismissAppIconForceTouchControllerIfNecessaryAnimated:(BOOL)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;
...
- (id)animator:(id)arg1 animationSettingsForOperation:(unsigned int)arg2 folderController:(id)arg3 childViewController:(id)arg4;
...
- (BOOL)_isShowingSlideOverSearch;
...
- (BOOL)presentSpotlightFromSource:(unsigned int)arg1 fromBreadcrumb:(BOOL)arg2 animated:(BOOL)arg3;
...
- (BOOL)isTransitioningFromCancelledCollapse;
...
- (void)addIcons:(id)arg1 intoFolderIcon:(id)arg2 animated:(BOOL)arg3 openFolderOnFinish:(BOOL)arg4 complete:(CDUnknownBlockType)arg5;
...
- (void)_animateFolderIcon:(id)arg1 open:(BOOL)arg2 animated:(BOOL)arg3 withCompletion:(CDUnknownBlockType)arg4;
...
- (void)openFolderIcon:(id)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)openFolder;
- (BOOL)hasOpenFolder;
