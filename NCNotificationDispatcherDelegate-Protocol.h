...
- (void)dispatcher:(NCNotificationDispatcher *)arg1 willExecuteAction:(NCNotificationAction *)arg2 forNotificationRequest:(NCNotificationRequest *)arg3 withParameters:(NSDictionary *)arg4 completionBlock:(void (^)(BOOL))arg5;
@end
