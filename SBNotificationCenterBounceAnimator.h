...
- (void)beginBounceWithInitialFrame:(struct CGRect)arg1 targetFrame:(struct CGRect)arg2 velocity:(struct CGPoint)arg3 removingGravityAtMidway:(BOOL)arg4 stepper:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
- (void)dealloc;
