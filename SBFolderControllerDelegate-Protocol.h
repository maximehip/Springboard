...
- (BOOL)folderController:(SBFolderController *)arg1 draggedIconMightDropFromListView:(SBIconListView *)arg2;
- (BOOL)folderController:(SBFolderController *)arg1 draggedIconDidMoveFromListView:(SBIconListView *)arg2 toListView:(SBIconListView *)arg3;
- (BOOL)folderController:(SBFolderController *)arg1 draggedIconDidPauseAtLocation:(struct CGPoint)arg2 inListView:(SBIconListView *)arg3;
