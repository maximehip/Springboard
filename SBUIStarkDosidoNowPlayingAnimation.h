...
- (void)_commonInitWithTransitionContextProvider:(id)arg1 starkScreenController:(id)arg2 waitForNowPlaying:(BOOL)arg3 initializationParametersBlock:(CDUnknownBlockType)arg4;
