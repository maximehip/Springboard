...
@property(nonatomic, getter=_counterRotatedAngle, setter=_setCounterRotatedAngle:) float counterRotatedAngle; // @synthesize counterRotatedAngle=_counterRotatedAngle;
