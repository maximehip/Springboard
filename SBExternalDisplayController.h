...
+ (id)sharedInstance;
@property(nonatomic, getter=_isListeningForApplicationStateChanges, setter=_setListeningForApplicationStateChanges:) BOOL listeningForApplicationStateChanges; // @synthesize listeningForApplicationStateChanges=_listeningForApplicationStateChanges;
