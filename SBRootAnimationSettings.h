...
@property float maxFolderCloseHintProgress; // @synthesize maxFolderCloseHintProgress=_maxFolderCloseHintProgress;
...
@property float maxAppSuspendHintProgress; // @synthesize maxAppSuspendHintProgress=_maxAppSuspendHintProgress;
