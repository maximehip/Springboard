...
- (void)_shutdownWithOptions:(unsigned int)arg1 description:(id)arg2;
- (void)_killAllAppsForPendingExitWithReason:(int)arg1 description:(id)arg2 expiration:(double)arg3 completion:(CDUnknownBlockType)arg4;
