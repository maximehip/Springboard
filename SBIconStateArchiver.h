...
+ (id)_listFromRepresentation:(id)arg1 withMaxIconCount:(unsigned int)arg2 context:(id)arg3 overflow:(id)arg4;
...
+ (id)_chunkIconList:(id)arg1 chunkSize:(unsigned int)arg2 folderChunkSize:(unsigned int)arg3;
+ (id)_chunkIconLists:(id)arg1 chunkSize:(unsigned int)arg2 folderChunkSize:(unsigned int)arg3;
