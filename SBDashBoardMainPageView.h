...
@class SBCallToActionLabel, SBDashBoardVibrantWallpaperButton, SBSlideUpAppGrabberView, SBWallpaperEffectView, UIView, UIView<SBUILegibility>, _UILegibilitySettings;
