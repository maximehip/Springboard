...
@optional
- (BOOL)synchronizedTransactionGroup:(FBSynchronizedTransactionGroup *)arg1 shouldFailForSynchronizedTransaction:(FBTransaction<FBSynchronizedTransaction> *)arg2;
@end
