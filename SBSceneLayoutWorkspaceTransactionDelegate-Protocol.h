...
- (void)transaction:(SBSceneLayoutWorkspaceTransaction *)arg1 didEndLayoutTransitionWithContinuation:(void (^)(SBWorkspaceApplicationTransitionContext *, unsigned int))arg2;
...
@optional
- (BOOL)transactionShouldConsiderLockStateForForegroundScenesDuringTransition:(SBSceneLayoutWorkspaceTransaction *)arg1;
@end
