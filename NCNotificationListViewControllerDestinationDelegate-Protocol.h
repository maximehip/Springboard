...
- (BOOL)notificationListViewController:(NCNotificationListViewController *)arg1 shouldAllowInteractionsForNotificationRequest:(NCNotificationRequest *)arg2;
...
- (void)notificationListViewController:(NCNotificationListViewController *)arg1 shouldFinishLongLookTransitionForNotification:(NCNotificationRequest *)arg2 withCompletionBlock:(void (^)(BOOL))arg3;
@end
