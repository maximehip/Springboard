...
+ (id)sharedInstance;
@property(nonatomic, getter=isEndingCallForLockButtonPress) BOOL endingCallForLockButtonPress; // @synthesize endingCallForLockButtonPress=_endingCallForLockButtonPress;
