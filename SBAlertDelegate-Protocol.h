...
- (void)alert:(SBAlert *)arg1 didChangeFaceContactExpectation:(BOOL)arg2;
- (unsigned int)defaultSupportedInterfaceOrientationsForAlert:(SBAlert *)arg1;
- (int)defaultInterfaceOrientationForPresentationOfAlert:(SBAlert *)arg1;
- (BOOL)defaultShouldAutorotateForAlert:(SBAlert *)arg1;
...
- (void)alert:(SBAlert *)arg1 didChangeStatusBarVisibility:(BOOL)arg2;
