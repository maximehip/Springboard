...
+ (id)sharedInstance;
- (void).cxx_destruct;
- (void)handlePushNotificationFromApplication:(id)arg1 userInfo:(id)arg2 priority:(int)arg3 completion:(CDUnknownBlockType)arg4;
- (id)_opportunisticallyUpdateApplications:(id)arg1 trigger:(unsigned int)arg2;
- (void)_performPendingWorkForBundleID:(id)arg1;
- (BOOL)_launchAppForUpdating:(id)arg1 trigger:(unsigned int)arg2 pushNotificationUserInfo:(id)arg3 withWatchdoggableCompletion:(CDUnknownBlockType)arg4;
- (BOOL)_appIsBeingDebugged:(id)arg1;
- (void)_startBackgroundFetchTaskForApplication:(id)arg1 trigger:(unsigned int)arg2 sequenceNumber:(int)arg3 withWatchdoggableCompletion:(CDUnknownBlockType)arg4;
- (void)queue_startBackgroundFetchTaskForApplication:(id)arg1 trigger:(unsigned int)arg2 sequenceNumber:(int)arg3 withWatchdoggableCompletion:(CDUnknownBlockType)arg4;
