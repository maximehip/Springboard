...
- (BOOL)removeLockScreenNotificationsPassingTest:(CDUnknownBlockType)arg1;
...
- (void)_addItem:(id)arg1 forBulletin:(id)arg2 playLightsAndSirens:(BOOL)arg3 withReply:(CDUnknownBlockType)arg4;
