...
@class BSTransaction<SBStartupTransition>, BSTransactionBlockObserver, NSString, SBInitialRestartState, SBStartupTransitionContextPersistence, SBStartupTransitionFactory;
