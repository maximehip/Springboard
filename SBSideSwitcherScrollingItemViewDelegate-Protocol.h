...
- (BOOL)sideSwitcherScroller:(SBSideSwitcherScrollingItemViewController *)arg1 displayItemWantsToBeKeptInViewHierarchy:(SBDisplayItem *)arg2;
- (float)sideSwitcherScrollerDistanceBetweenItems:(SBSideSwitcherScrollingItemViewController *)arg1;
