...
- (void)_presentAuthenticationUIForInstallation:(CDUnknownBlockType)arg1 withInstallType:(unsigned int)arg2 withInstallOperation:(id)arg3;
...
- (void)_scheduleInstallAlertReminderWithDate:(id)arg1 repopStrategy:(unsigned int)arg2 forReason:(id)arg3;
...
- (BOOL)_doesStateContainNonInstallableReasons:(int)arg1 reasonsToCheck:(id)arg2 outMatchingReasonsString:(id *)arg3;
- (void)_isUpdateInstallable:(CDUnknownBlockType)arg1;
- (BOOL)_showNextInstallAlertWithReasons:(int)arg1 orScheduleIfNecessary:(BOOL)arg2 withInstallOptions:(id)arg3;
- (BOOL)_showNextInstallAlertWithReasons:(int)arg1 orScheduleIfNecessary:(BOOL)arg2;
...
- (void)_realertWithStrategy:(unsigned int)arg1 andReason:(id)arg2;
- (id)_computeNextLastPredictedUnlockDateMinus4HoursFromStartDate:(id)arg1;
- (id)_getNextLastPredictedUnlockDateFromDuet:(id)arg1;
- (void)_dismissInstallAlertsWithReason:(id)arg1 includingInstallTonight:(BOOL)arg2 withRealertStrategy:(unsigned int)arg3;
...
- (void)_installUpdate:(unsigned int)arg1 withInstallOperation:(id)arg2 source:(unsigned int)arg3 options:(id)arg4;
- (void)_autoInstallOperationDidExpire:(id)arg1 withRepopStrategy:(unsigned int)arg2;
- (void)_autoInstallOperationWasCancelled:(id)arg1 withRepopStrategy:(unsigned int)arg2;
...
- (void)alertModel:(id)arg1 alertFlowDidChangeFrom:(unsigned int)arg2 to:(unsigned int)arg3;
...
- (void)installNowFromSource:(unsigned int)arg1 options:(id)arg2;
- (void)installNowFromSource:(unsigned int)arg1;
