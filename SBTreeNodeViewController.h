...
- (void)_performOperation:(int)arg1 animated:(BOOL)arg2 fromViewController:(id)arg3 fromIndexPath:(id)arg4 toViewController:(id)arg5 toIndexPath:(id)arg6 withContinuation:(CDUnknownBlockType)arg7 completion:(CDUnknownBlockType)arg8;
...
- (void)_transitionToExpandedIndexPath:(id)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)_setExpandedIndexPath:(id)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (id)_rootParentViewController;
- (id)_expandedIndexPathWithPartialPath:(id *)arg1;
- (BOOL)_shouldRemoveViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 fromIndexPath:(id)arg3 toViewController:(id)arg4 toIndexPath:(id)arg5;
- (BOOL)_shouldAddViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 fromIndexPath:(id)arg3 toViewController:(id)arg4 toIndexPath:(id)arg5;
- (BOOL)_shouldRemoveViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 fromIndexPath:(id)arg3 toViewController:(id)arg4 toIndexPath:(id)arg5 canceled:(BOOL)arg6;
- (BOOL)_shouldAddViewController:(id)arg1 afterTransitionFromViewController:(id)arg2 fromIndexPath:(id)arg3 toViewController:(id)arg4 toIndexPath:(id)arg5 canceled:(BOOL)arg6;
...
- (id)treeNodeViewController:(id)arg1 animationControllerForOperation:(int)arg2 animated:(BOOL)arg3 fromViewController:(id)arg4 fromIndexPath:(id)arg5 toViewController:(id)arg6 toIndexPath:(id)arg7;
...
- (struct CGRect)frameForChildTreeNodeViewController:(id)arg1 atIndexPath:(id)arg2 inState:(int)arg3 withParentContainerSize:(struct CGSize)arg4;
...
- (BOOL)isExpandedForContainingExpandedIndexPath:(id)arg1;
...
- (void)setExpandedIndexPaths:(id)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)popExpandedIndexPathAnimated:(BOOL)arg1 withCompletion:(CDUnknownBlockType)arg2;
- (void)pushExpandedIndexPath:(id)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
- (void)setExpandedIndexPath:(id)arg1 animated:(BOOL)arg2 withCompletion:(CDUnknownBlockType)arg3;
