...
@property(nonatomic) BOOL containsDateTimeDisplay; // @synthesize containsDateTimeDisplay=_containsDateTimeDisplay;
@property(nonatomic) BOOL todayViewShouldBeOffset; // @synthesize todayViewShouldBeOffset=_todayViewShouldBeOffset;
...
- (void).cxx_destruct;
- (void)setCurrentStyle:(unsigned int)arg1;
- (void)_layoutWeather;
