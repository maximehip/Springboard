...
- (void)finishInteractiveTransition:(id <SBViewControllerContextTransitioning>)arg1 withCompletionSpeed:(float)arg2 completionCurve:(int)arg3;
- (void)updateTransition:(id <SBViewControllerContextTransitioning>)arg1 withPercentComplete:(float)arg2;
@end
