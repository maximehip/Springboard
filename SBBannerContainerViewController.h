...
@property(readonly, nonatomic, getter=isPulledDown) BOOL pulledDown; // @synthesize pulledDown=_pulledDown;
...
- (void)buttonViewController:(id)arg1 didSelectButtonAtIndex:(unsigned int)arg2;
