...
- (void)_configureAnimatedForText:(id)arg1 highlighted:(BOOL)arg2 withPreparation:(CDUnknownBlockType)arg3 animation:(CDUnknownBlockType)arg4 completion:(CDUnknownBlockType)arg5;
...
- (void)configureAnimatedForIcon:(id)arg1 location:(int)arg2 highlighted:(BOOL)arg3 withPreparation:(CDUnknownBlockType)arg4 animation:(CDUnknownBlockType)arg5 completion:(CDUnknownBlockType)arg6;
- (void)layoutSubviews;
- (void)dealloc;
- (id)init;
