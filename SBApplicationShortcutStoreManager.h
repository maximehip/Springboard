...
- (void)setApplicationShortcutItems:(id)arg1 forBundleIdentifier:(id)arg2 withVersion:(unsigned int)arg3;
- (id)applicationShortcutItemsForBundleIdentifier:(id)arg1 withVersion:(unsigned int)arg2;
- (void)dealloc;
- (id)init;
