...
@class BSPluginBundle, FBProcess, NSString, SBDashBoardAppearance, SBDashBoardBehavior, SBLockOverlayContext, SBLockScreenPluginAction, SBLockScreenPluginAppearanceContext, UIViewController<SBLockScreenPluginViewController>;
...
- (BOOL)isCapabilityRestricted:(unsigned int)arg1;
- (id)overrideForElement:(int)arg1;
- (BOOL)isElementHidden:(int)arg1;
