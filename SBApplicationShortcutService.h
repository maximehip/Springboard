...
- (void)applicationServer:(id)arg1 client:(id)arg2 fetchApplicationShortcutItemsOfTypes:(unsigned int)arg3 forBundleIdentifier:(id)arg4 withCompletion:(CDUnknownBlockType)arg5;
- (id)_sanitizeApplicationShortcutItems:(id)arg1 withEntitlements:(unsigned int)arg2;
