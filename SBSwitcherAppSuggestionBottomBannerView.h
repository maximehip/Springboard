...
@property(nonatomic) BOOL usesFakeBlur; // @synthesize usesFakeBlur=_usesFakeBlur;
- (void).cxx_destruct;
...
- (id)initWithFrame:(struct CGRect)arg1 appSuggestion:(id)arg2 style:(unsigned int)arg3;
