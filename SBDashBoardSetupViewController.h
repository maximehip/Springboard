...
@property(nonatomic, getter=_shouldResetOrderingOnNextCycle, setter=_setShouldResetOrderingOnNextCycle:) BOOL shouldResetOrderingOnNextCycle; // @synthesize shouldResetOrderingOnNextCycle=_shouldResetOrderingOnNextCycle;
...
@property(nonatomic, getter=_currentStringIndex, setter=_setCurrentStringIndex:) unsigned int currentStringIndex; // @synthesize currentStringIndex=_currentStringIndex;
