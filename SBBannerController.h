...
- (void)_handleSystemDismissGestureWithState:(int)arg1 position:(struct CGPoint)arg2 velocity:(struct CGPoint)arg3;
...
- (void)dismissBannerWithAnimation:(BOOL)arg1 reason:(int)arg2 forceEvenIfBusy:(BOOL)arg3 completion:(CDUnknownBlockType)arg4;
