...
- (void)resizeUIManager:(SBMainDisplaySceneLayoutResizeUIManager *)arg1 willChangeDisplayModeOfAppController:(SBAppContainerViewController *)arg2 toDisplayMode:(int)arg3;
- (void)resizeUIManager:(SBMainDisplaySceneLayoutResizeUIManager *)arg1 willChangeToState:(unsigned int)arg2;
