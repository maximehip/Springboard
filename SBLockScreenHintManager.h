...
@interface SBLockScreenHintManager : NSObject <UIGestureRecognizerDelegate, SBPresentingDelegate, CCUIControlCenterObserver, SBUIBiometricEventObserver>
{
    ...
    unsigned int _activeHintEdge;
    NSDate *_initialTouchTimeStamp;
    struct CGPoint _initialPanLocationInViewSpace;
}

@property(nonatomic, getter=isFingerOnMesa) BOOL fingerOnMesa; // @synthesize fingerOnMesa=_fingerOnMesa;
@property(nonatomic) BOOL didEvaluatePressDelay; // @synthesize didEvaluatePressDelay=_didEvaluatePressDelay;
@property(nonatomic, getter=isGuestGestureActive) BOOL guestGestureActive; // @synthesize guestGestureActive=_guestGestureActive;
@property(retain, nonatomic) NSDate *initialTouchTimeStamp; // @synthesize initialTouchTimeStamp=_initialTouchTimeStamp;
@property(nonatomic) unsigned int activeHintEdge; // @synthesize activeHintEdge=_activeHintEdge;
...
@property(nonatomic, getter=isGestureHandlingEnabled) BOOL gestureHandlingEnabled; // @synthesize gestureHandlingEnabled=_gestureHandlingEnabled;
...
- (void)_updateControllerPresentationForTapOrPress:(id)arg1 withAnimation:(CDUnknownBlockType)arg2 abortingCurrentAnimation:(BOOL)arg3;
...
- (BOOL)_isPresentationEnabledForController:(id)arg1 locationInWindow:(struct CGPoint)arg2;
- (BOOL)_isBounceEnabledForController:(id)arg1 locationInWindow:(struct CGPoint)arg2;
...
- (unsigned int)_hintEdgeForController:(id)arg1;
- (BOOL)_didActiveControllerChange;
- (id)_controllerForGesture:(id)arg1;
- (BOOL)_canControllerWithIdentifier:(int)arg1 becomeActiveWithTouchAtLocation:(struct CGPoint)arg2;
